<?php
echo
	$this->element('adminhdr',array('links'=>array(
		array('text'=>'Obtener Emails','href'=>false,'class'=>'edit','atts'=>array('id'=>'getemails')),
		'export'
	))),
	...
	$html->div(null,
		$html->tag('p','Haga clic en el cuadro de texto y después de seleccionarse el contenido, presione "Ctrl + C" (Windows) ó "Command + C" (Mac) para copiarlo. Presione "Ctrl + V" (Windows) ó "Command + V" (Mac) para pegarlo donde desee.').
		$form->input(null,array('id'=>'allEmailsText','rows'=>4))
	,array('id'=>'allEmails')),

	$moo->buffer('$("allEmails").slide("hide");'),
	$moo->addEvent('getemails','click',array('url'=>'/admin/suscriptors/getemails/','update'=>'"allEmailsText"','oncomplete'=>'$("allEmails").slide("in");')),
